...
public class ByteArrayUtils
{
    ...
    public static int putLongValuesWithNullsToBuffer(long[] values, boolean[] nulls, int[] positions, int positionsOffset, int batchSize, int offsetBase, byte[] target, int targetIndex)
    {
        //if (sizeOf(target) < targetIndex + batchSize * ARRAY_LONG_INDEX_SCALE || targetIndex < 0) {
        if (target.length < targetIndex + batchSize * ARRAY_LONG_INDEX_SCALE || targetIndex < 0) {
            throw new IndexOutOfBoundsException();
...
//    public static int putAllLongValuesToBuffer(long[] values, int positionsOffset, int batchSize, int offsetBase, byte[] target, int targetIndex)
//    {
//        //if (sizeOf(target) < targetIndex + batchSize * ARRAY_LONG_INDEX_SCALE || targetIndex < 0) {
...
//            // Note that positions is logical row number. It may not start from 0 in the values array.
//            unsafe.putLong(target, (long) targetIndex, values[position + offsetBase]);
//            targetIndex += ARRAY_LONG_INDEX_SCALE;
//        }
//        return targetIndex;
//    }

//    public static int putAllLongValuesWithNullsToBuffer(long[] values, boolean[] nulls, int positionsOffset, int batchSize, int offsetBase, byte[] target, int targetIndex)
//    {
//        //if (sizeOf(target) < targetIndex + batchSize * ARRAY_LONG_INDEX_SCALE || targetIndex < 0) {
//        if (target.length < targetIndex - ARRAY_BYTE_BASE_OFFSET + batchSize * ARRAY_LONG_INDEX_SCALE || targetIndex < 0) {
//            throw new IndexOutOfBoundsException();
...
//    }
//
//    public static int setInt1(byte[] bytes, int index, int value)
//    {
...
//    public static void setInt2(byte[] bytes, int index, int value)
//    {
//        unsafe.putInt(bytes, (long) index, value);
//    }
//
