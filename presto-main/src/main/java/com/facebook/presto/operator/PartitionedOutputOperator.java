...
//                timeForCalculateNumberRowsFitInBuffers += five - four;
                ...
                // This check has to be done in the (nested) blocks
//                verify(positionsWritten + numberOfRowsFit < positions.length && positions[positionsWritten + numberOfRowsFit] < page.getPositionCount(),
//                        format("positionsWritten %d and numberOfRowsFit %d should be smaller than the positions array length %d", positionsWritten, numberOfRowsFit, positions.length));
                ...
                for (int i = 0; i < page.getChannelCount(); i++) {
                    ...
                    blockEncodingBuffers[i].copyValues(block);
                }
