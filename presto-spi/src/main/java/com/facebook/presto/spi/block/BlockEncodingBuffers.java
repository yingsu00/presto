...
public abstract class BlockEncodingBuffers
{
    ...
    protected int positionCount;  // count in positions array
    ...
    public void setupPositions(int[] positions, int positionCount)
    {
    ...
    protected void appendPositionRange(int offset, int addedLength)
    {
        ...
        positionCount += addedLength;
        // TODO: does this need to be optmized away?
        batchSize = positionCount;
    }
